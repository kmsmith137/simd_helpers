...
template<> inline simd_t<int64_t,2> simd_cast(simd_t<double,2> x)  { return _mm_castpd_si128(x.x); }
template<> inline simd_t<double,2> simd_cast(simd_t<int64_t,2> x)  { return _mm_castsi128_pd(x.x); }
